"""
Tests for aria_esi.store.market.clipboard
...
class TestParseClipboard:
    ...
    def test_empty_input(self):
        from aria_esi.store.market.clipboard import parse_clipboard
...
class TestParseQuantity:
    ...
    def test_basic_integer(self):
        from aria_esi.store.market.clipboard import _parse_quantity
...
class TestItemsToDict:
    ...
    def test_converts_parsed_items(self):
        from aria_esi.store.market.clipboard import ParsedItem, items_to_dict
    ...
    def test_empty_list(self):
        from aria_esi.store.market.clipboard import items_to_dict
