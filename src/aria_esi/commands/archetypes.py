...
def cmd_archetype_recommend(args: argparse.Namespace) -> dict[str, Any]:
    ...
    clone_status_raw: str = getattr(args, "clone", "omega")
    if clone_status_raw not in ("alpha", "omega"):
        clone_status_raw = "omega"
    clone_status = cast(Literal["alpha", "omega"], clone_status_raw)
