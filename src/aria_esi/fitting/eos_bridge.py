...
# EVE SDE order: EM(271), Explosive(272), Kinetic(273), Thermal(274)
...
# EVE SDE order: EM(974), Explosive(975), Kinetic(976), Thermal(977)
ATTR_HULL_EM_RESIST = 974
ATTR_HULL_EXPLOSIVE_RESIST = 975
ATTR_HULL_KINETIC_RESIST = 976
ATTR_HULL_THERMAL_RESIST = 977
