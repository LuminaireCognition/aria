...
from aria_esi._vendor.eos.eve_obj.effect.repairs.base import LocalArmorRepairEffect
from aria_esi._vendor.eos.eve_obj.effect.repairs.base import RemoteArmorRepairEffect
