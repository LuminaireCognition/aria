...
from aria_esi._vendor.eos.eve_obj.effect.repairs.base import LocalShieldRepairEffect
from aria_esi._vendor.eos.eve_obj.effect.repairs.base import RemoteShieldRepairEffect
