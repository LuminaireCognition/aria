...
This skill evaluates potential targets from an aggressor perspective. Empire pilots can use:

- `/threat-assessment` - Evaluate system and route safety (defensive)
- `/price` - Check item and ship values
