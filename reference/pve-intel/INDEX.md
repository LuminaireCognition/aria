...
| Faction | They Deal | You Deal |
|---------|-----------|----------|
| Serpentis | Kin/Therm | Therm > Kin |
| Angel Cartel | Exp/Kin | Exp > Kin |
| Blood Raiders | EM/Therm | EM > Therm |
...
| Faction | Common EWAR | Counter |
|---------|-------------|---------|
| Serpentis | Sensor Damp | Close range, missiles |
| Guristas | ECM (Target Jam) | Drones, multiple targets |
| Blood Raiders | Tracking Disrupt | Missiles |
